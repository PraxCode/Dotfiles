...
theme.taglist_font                              = "JetBrains Mono Medium 34"
...
--theme.widget_vol_mute                           = theme.dir .. ""
...
function theme.at_screen_connect(s)
  ...
  s.mywibox:setup {
    ...
    { -- Right widgets
      ...
      --theme.volume.widget,
      --arrl_ld,
      --mailbox.container.background(mailicon, theme.bg_focus),
      ...
      --spr,
      --arrl_ld,
      wibox.container.background(s.mylayoutbox, "1F2227"),
    },
  }
end
